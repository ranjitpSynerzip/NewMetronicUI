...
@Component({
  selector: 'kt-add-projectgroup',
  templateUrl: './add-projectgroup.component.html',
  styleUrls: ['./add-projectgroup.component.scss']
})
export class AddProjectgroupComponent implements OnInit {
  ...
  onSaveButton() {
    ...
    this.service.postProjectGroup(this.projectObj).subscribe(
      success => {
        ...
        this.router.navigateByUrl('/projectgroups/projectgrouplist');
